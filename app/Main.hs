...
import Core.CLI (processFile, processFileToJS, processFileToHVM, listDependencies, getGenDeps, processFileToCore, processFileToHS, processFileToKC)
...
main = do
  ...
  case args of
    ...
    [file, "--to-kolmoc"] | ".bend"    `isSuffixOf` file -> processFileToKC file
    [file, "--to-kolmoc"] | ".bend.py" `isSuffixOf` file -> processFileToKC file
