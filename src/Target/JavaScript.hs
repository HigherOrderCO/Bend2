...
compile :: Book -> String
compile (Book defs names constructors) =
  let ctDefs = map (\(name, (_, term, _)) -> (name, termToCT (Book defs names constructors) term 0)) (M.toList defs)
