...
-- TODO: update the Check.hs module to use the new Core.Term module
-- before writing the code, take a moment to reason about the new ADT type, and
-- how type checking for it should work.
