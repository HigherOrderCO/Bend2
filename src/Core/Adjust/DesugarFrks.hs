...
desugarFrksGo book d ctx (ADT n ts)    = ADT n (map (desugarFrksGo book d ctx) ts)
desugarFrksGo book d ctx (Ctr n ts)    = Ctr n (map (desugarFrksGo book d ctx) ts)
desugarFrksGo book d ctx (ADTM n cs m) = ADTM n [(c, desugarFrksGo book d ctx t) | (c, t) <- cs] (fmap (desugarFrksGo book d ctx) m)
